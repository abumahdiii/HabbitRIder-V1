...
- **CRITICAL RULE (Scripts Permission):** You must NEVER run any build scripts, execution commands, or generate zip files unless explicitly instructed by the user.
